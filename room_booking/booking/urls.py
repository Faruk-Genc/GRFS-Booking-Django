...
urlpatterns = [
    ...
    path('available_rooms/', AvailableRoomsView.as_view(), name='available-rooms'),
    path('camp-booking-warnings/', UpcomingCampBookingsView.as_view(), name='camp-booking-warnings'),
    ...
    path('auth/refresh/', ApprovedTokenRefreshView.as_view(), name='token_refresh'),
